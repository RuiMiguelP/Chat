...
a persistence unit "proj6_data_serverPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proj6_data_server\pom.xml":
...
artifact ("proj6_data_server.war") is already built. You can build
