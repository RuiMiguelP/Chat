...
a persistence unit "proj6_webPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proj6_web\pom.xml":
...
artifact ("proj6_web.war") is already built. You can build
