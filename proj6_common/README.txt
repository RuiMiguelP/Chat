...
a persistence unit "proj6_commonPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proj6_common\pom.xml":
...
artifact ("proj6_common.war") is already built. You can build
