...
a persistence unit "proj6_web_serverPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proj6_web_server\pom.xml":
...
artifact ("proj6_web_server.war") is already built. You can build
